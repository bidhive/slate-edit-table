...
import { Block, type Change, type SlateError } from 'slate';
 ...
 */
function onlyCellsInRow(opts: Options, change: Change, error: SlateError) {
 ...
 */
function rowOnlyInTable(opts: Options, change: Change, error: SlateError) {
 ...
 */
function onlyBlocksInCell(opts: Options, change: Change, error: SlateError) {
 ...
 */
function cellOnlyInRow(opts: Options, change: Change, error: SlateError) {
