...
function getCopiedFragment(opts, value) {
    ...
    var startPosition = _utils.TablePosition.create(opts, document, selection.start.key);
    var endPosition = _utils.TablePosition.create(opts, document, selection.end.key);
