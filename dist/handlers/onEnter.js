...
function onEnter(event, change, editor, opts) {
    ...
    var pos = _utils.TablePosition.create(opts, document, selection.start.key);

    if (!selection.focus.isAtStartOfNode(pos.cell) && !selection.focus.isAtEndOfNode(pos.cell)) {
        return undefined;
    }
